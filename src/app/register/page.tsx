            ...
            <div className="flex flex-col justify-evenly rounded-xl w-[450px] h-[620px] bg-white shadow-md">
                ...
                <div className="flex justify-center items-center h-[100%]">
                    <div className="flex justify-center items-center flex-col gap-8">
                        <h1 className="font-extrabold text-3xl">Welcome Benz</h1>
                ...
                <div className="h-[100%]  flex flex-col items-center justify-between">
                    <button onClick={Register} className="font-bold text-white  w-[270px] h-[40px] rounded-3xl bg-gradient-to-r from-sky-300 via-violet-600 to-fuchsia-400 hover:scale-110">Register</button>
                </div>
            </div>
        </div>
    )
